...
import { Banknote, Calendar, CalendarCheck2, ChevronLeft, ChevronRight, Folder, List, Settings } from "lucide-react";
...
function SidebarLink({ href, label, icon, pathName, isCollapsed }: SidebarLinkProps) {
    return (
        <Link
            href={href}
        >
            <div className={clsx("flex items-center gap-2 px-3 py-2 rounded-md transition-colorsio", {
