...
export function Hero() {
    return (
        <section className="bg-white">
            ...
            <div className="container mx-auto px-4 pt-20 pb-4 sm:pb-0 sm:px6 lg:px-8">
                <main className="flex items-center justify-center">
                    ...
                    <article className="flex-2 max-w-3xl space-y-8 flex flex-col justify-center">
                        ...
                        <p className="text-base md:text-lg text-gray-600">Nós somos uma plataforma para profissionais da sáude com foco em agilizar seu atendimento de forma simplificada e organizada</p>
